  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex rounded-full overflow-hidden shadow-md">
        ...
        <Link
          href="/auth/login"
          className="px-6 py-2 font-medium text-[var(--header-text)] transition-all duration-200 cursor-pointer"
        ...
        <Link
          href="/auth/signup"
          className="px-6 py-2 font-medium text-[var(--signup-text)] transition-all duration-200 cursor-pointer"
